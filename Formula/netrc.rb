class Netrc < Formula
  ...
  if Hardware::CPU.intel?
    url "https://github.com/dokku/netrc/releases/download/v0.10.3/netrc-darwin-amd64"
    sha256 "77bc106aba0da00033140515e5381603b001caa5dfb889d468198763eade6ac8"
  else
    url "https://github.com/dokku/netrc/releases/download/v0.10.3/netrc-darwin-arm64"
