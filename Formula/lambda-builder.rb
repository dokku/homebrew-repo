class LambdaBuilder < Formula
  ...
  if Hardware::CPU.intel?
    url "https://github.com/dokku/lambda-builder/releases/download/v0.9.2/lambda-builder-darwin-amd64"
    sha256 "9cee4a0ec028d2b1bd10282b80c89fa9f515942313c3ca20bae56691be47fae4"
  else
    url "https://github.com/dokku/lambda-builder/releases/download/v0.9.2/lambda-builder-darwin-arm64"
